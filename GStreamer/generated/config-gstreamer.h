...
#define GST_PACKAGE_NAME "P1stream GStreamer bundle"

/* package origin */
#define GST_PACKAGE_ORIGIN "P1stream"

/* GStreamer package release date/time for plugins as YYYY-MM-DD */
#define GST_PACKAGE_RELEASE_DATETIME "2013-01-08"

/* location of the installed gst-plugin-scanner */
#define GST_PLUGIN_SCANNER_INSTALLED "DISABLED"
...
/* Name of package */
#define PACKAGE "gstreamer-bundle"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "https://github.com/stephank/P1stream/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "P1stream GStreamer bundle"
