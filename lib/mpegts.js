...
exports.videoFrame = function(frame, ctx) {
    ...
    return packFrame(b, ctx, 0x23, 0xE0, frame.pts);
};
...
exports.audioFrame = function(frame, ctx) {
    ...
    return packFrame(b, ctx, 0x22, 0xC0, frame.pts);
};

function packFrame(inb, ctx, pid, streamId, pts) {
    var bytes = inb.length;

    // How much space per packet we have for the payload
    var chunkSize = 184;
    var firstChunkSize = chunkSize - (pts ? 14 : 9);
