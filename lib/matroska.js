        ...
        T.Segment([
            ...
            T.Tracks([
                T.TrackEntry([
                    ...
                    T.CodecPrivate(buildVideoPrivate(videoHeaders)),
                    T.CodecDecodeAll(1),
                    T.SeekPreRoll(0),
                    T.Video([
                        T.FlagInterlaced(0),
                ...
                T.TrackEntry([
                    ...
                    T.MaxBlockAdditionID(0),
                    T.CodecID('A_AAC'),
                    T.CodecPrivate(buildAudioPrivate(audioHeaders)),
                    T.CodecDecodeAll(1),
                    T.SeekPreRoll(0),
                    T.Audio([
...
function buildVideoPrivate(videoHeaders) {
    var parts = [];
    var b;
...
function buildAudioPrivate(audioHeaders) {
    return audioHeaders.buf;
}
